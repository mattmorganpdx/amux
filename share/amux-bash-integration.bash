#!/usr/bin/env bash
# amux bash shell integration
# Source this file from your .bashrc:
#   [ -n "$AMUX_WORKSPACE_ID" ] && source /path/to/amux-bash-integration.bash
#
...
if [[ -z "$PROMPT_COMMAND" ]]; then
    PROMPT_COMMAND="_amux_precmd"
elif [[ "$PROMPT_COMMAND" != *"_amux_precmd"* ]]; then
    PROMPT_COMMAND="_amux_precmd;$PROMPT_COMMAND"
fi
